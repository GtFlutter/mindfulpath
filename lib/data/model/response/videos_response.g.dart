...
VideosResponse _$VideosResponseFromJson(Map<String, dynamic> json, bool isFromAudio) =>
    VideosResponse(
          ...
          list: (json['list'] as List<dynamic>?)
              ?.map((e) => VideoResponse.fromJson(e as Map<String, dynamic>, isFromAudio))
              .toList(),
...
VideoResponse _$VideoResponseFromJson(Map<String, dynamic> json, bool isFromAudio) =>
    VideoResponse(
      ...
      videoType: ResourceType.fromJson((json['video_type'] as num?)?.toInt()),
