...
final paidVideosProvider = ChangeNotifierProvider<PaidVideosNotifier>((ref) {
  final repo = ref.watch(dashboardRepoProvider);
  return PaidVideosNotifier(repo);
});

class PaidVideosNotifier extends VideoResourceNotifier {
  final DashboardRepo repo;
  PaidVideosNotifier(this.repo);
