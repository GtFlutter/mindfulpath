...
final freePdfsProvider = ChangeNotifierProvider<FreePdfsNotifier>((ref) {
  final repo = ref.watch(dashboardRepoProvider);
  return FreePdfsNotifier(repo);
});

class FreePdfsNotifier extends PdfResourceNotifier {
  final DashboardRepo repo;
  FreePdfsNotifier(this.repo);
