...
class PaidAllItemListWidget extends ConsumerStatefulWidget {
  ...
  const PaidAllItemListWidget({Key? key, required this.category}) : super(key: key);

  @override
  ConsumerState<PaidAllItemListWidget> createState() => _PaidAllItemListWidgetState();
}

class _PaidAllItemListWidgetState extends ConsumerState<PaidAllItemListWidget> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> initCall() async {
    final provider = ref.read(paidAllItemProvider.notifier);
  ...
  @override
  void didUpdateWidget(covariant PaidAllItemListWidget oldWidget) {
  ...
  List<dynamic> get flatItems {
    final allItemProvider = ref.watch(paidAllItemProvider);
