...
class FreeVideoListWidget extends ConsumerStatefulWidget {
  ...
  const FreeVideoListWidget({super.key, required this.categoryTitle, required this.categoryId});
...
class _FreeVideoListWidgetState extends ConsumerState<FreeVideoListWidget> with AutomaticKeepAliveClientMixin {
  ...
  @override
  void initState() {
    Future.delayed(Duration.zero, () => ref.read(freeVideosProvider).fetchVideos(widget.categoryId));
    super.initState();
  }
