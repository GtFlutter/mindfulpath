...
class _FlutterSwitchState extends State<FlutterSwitch> with SingleTickerProviderStateMixin {
  ...
  late final Animation _toggleSizeAnimation;
  late final Animation _toggleMarginAnimation;
  ...
  void initState() {
    ...
    _toggleSizeAnimation = Tween<double>(
      begin: widget.toggleSize * 0.8,
      end: widget.toggleSize,
    ).animate(
      CurvedAnimation(parent: _animationController, curve: Curves.bounceInOut),
    );
    _toggleMarginAnimation = Tween<double>(
      begin: ((widget.toggleSize * 0.2) / 2) + widget.toggleMargin,
      end: widget.toggleMargin,
    ).animate(
      CurvedAnimation(parent: _animationController, curve: Curves.bounceInOut),
    );
  }
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        width: _toggleSizeAnimation.value,
                        height: _toggleSizeAnimation.value,
                        margin: EdgeInsets.symmetric(
                            horizontal: widget.toggleMargin, vertical: _toggleMarginAnimation.value),
                        decoration: BoxDecoration(
